...
class data_sb extends uvm_scoreboard;
    ...
    uvm_analysis_export #(axi_r_item) r_ap;
    ...
    uvm_tlm_analysis_fifo #(axi_r_item) r_fifo;
    ...
    function new(string n="data_sb", uvm_component p); 
        super.new(n,p); 
    endfunction
    ...
    task process_wr();
        ...
        forever begin
            ...
            if(wt.last && wr_beat[key] != at.len+1) begin 
                error_cnt++;
